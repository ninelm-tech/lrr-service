...
// Temporary — processQuoteOrDecline/startDispatch haven't fully migrated
// off this service's WhatsApp handlers yet (Task 7 in the same
// decomposition moves the operator/customer WhatsApp flows out).
// Depending on DispatchService for these calls is intentional and
